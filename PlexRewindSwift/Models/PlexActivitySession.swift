...
struct PlexActivitySession: Decodable, Identifiable {
    ...
    enum CodingKeys: String, CodingKey {
        case ratingKey, sessionKey, title, type, duration, viewOffset, art, contentRating, grandparentArt, grandparentTitle, grandparentRatingKey, parentThumb, grandparentThumb, thumb, summary, parentIndex, index, year, media = "Media", user = "User", player = "Player", session = "Session", transcodeSession = "TranscodeSession"
    }
}
